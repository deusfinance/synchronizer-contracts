    ...
    },
    {
      ...
      value: (function () {
        var _request = _asyncToGenerator(
          /*#__PURE__*/ regenerator.mark(function _callee(dataInfo) {
            var apiInstance,
              muonResponse,
              result,
              responseData,
                ...
                while (1) {
                  switch ((_context.prev = _context.next)) {
                    ...
                    case 4:
                      ...
                      if (result.confirmed) {
                        reqId = "0x".concat(
                          (_result$cid = result.cid) === null ||
                            _result$cid === void 0
                            ? void 0
                            : _result$cid.substr(1)
                        );
                        groupAddress =
                          (_result$signatures$ = result.signatures[0]) ===
                            null || _result$signatures$ === void 0
                            ? void 0
                            : _result$signatures$.owner;
                        signature =
                          (_result$signatures$2 =
                            result.signatures[0]) === null ||
                          _result$signatures$2 === void 0
                            ? void 0
                            : _result$signatures$2.signature;
                        nonceAddress =
                          (_result$data = result.data) === null ||
                          _result$data === void 0
                            ? void 0
                            : (_result$data$init = _result$data.init) ===
                                null || _result$data$init === void 0
                            ? void 0
                            : _result$data$init.nonceAddress;
                        sigs = [
                          {
                            signature: signature,
                            owner: groupAddress,
